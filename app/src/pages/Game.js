const Game = {
    ...
    renderHeader: (className = "container", ...rest) => {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" class="back-arrow-game" id="backArrowGame">
            <polygon style="fill:#FFE777;" points="466.989,118.154 498.497,256 466.989,393.846 256,393.846 256,461.363 0,256 256,50.637 
	        256,118.154 "/>
            <g>
	            <rect x="466.989" y="118.154" style="fill:#FEDC3D;" width="45.011" height="275.692"/>
	            <circle style="fill:#FEDC3D;" cx="177.793" cy="334.769" r="8.44"/>
	            <circle style="fill:#FEDC3D;" cx="135.033" cy="301.011" r="8.44"/>
            </g>
            </svg>
        </div>
