...
<g>
    ...
    this.playAudioCorrectAnswer = function () {
      ...
      audioCorrectSound.innerHTML = `<source src="https://github.com/JennyTara/flaggy/blob/main/app/assets/correct-answer.mp3?raw=true" type="audio/mp3">`
    ...
    this.playAudioWrongAnswer = function () {
      ...
      audioWrongSound.innerHTML = `<source src="https://github.com/JennyTara/flaggy/blob/main/app/assets/wrong-answer.mp3?raw=true" type="audio/mp3">`
